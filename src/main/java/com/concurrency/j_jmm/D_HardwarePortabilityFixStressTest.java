...
@State
public class D_HardwarePortabilityFixStressTest {

    // Plain fields representing a custom payload structure
    private int configValue = 0;
    // Fixes the cross-architecture leak completely by making the flag volatile, which creates a full memory barrier on both sides.
